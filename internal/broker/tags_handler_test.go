...
func TestHandleFilterToolsByTags_match(t *testing.T) {
	...
	req := &mcp.CallToolRequest{Params: &mcp.CallToolParamsRaw{Arguments: mustMarshalArgs(map[string]any{"tags": []any{"prod", "finance"}})}}
...
func TestHandleFilterToolsByTags_no_match(t *testing.T) {
	...
	req := &mcp.CallToolRequest{Params: &mcp.CallToolParamsRaw{Arguments: mustMarshalArgs(map[string]any{"tags": []any{"prod"}})}}
...
func TestHandleFilterToolsByTags_empty_tags(t *testing.T) {
	...
	req := &mcp.CallToolRequest{Params: &mcp.CallToolParamsRaw{Arguments: mustMarshalArgs(map[string]any{"tags": []any{}})}}
