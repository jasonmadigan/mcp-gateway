...
// AddTools registers tools with the SDK server and the local index.
...
// DeleteTools removes tools from the SDK server and the local index.
...
// ListTools returns a snapshot of the registered tools by served name.
...
// AddPrompts registers prompts with the SDK server and the local index.
...
// DeletePrompts removes prompts from the SDK server and the local index.
...
// ListPrompts returns a snapshot of the registered prompts by served name.
