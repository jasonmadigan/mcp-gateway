...
func TestFetchUserSpecificTools_SessionCaching(t *testing.T) {
	...
	// verify session was cached for tools/call routing
	...
	// second call: should reuse the pooled session, no second initialize
...
// seedUserSession pools an upstream session for the given gateway session.
